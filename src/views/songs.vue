<template>
  <div class="w-full">
    <button @click="playSound()" class="px-2 py-4 bg-green-200">Play</button>
    ...
    <div class="w-full">
          ...
          <template v-for="song in songs" :key="song.id">
            <div class="col-4 col-md-3 col-lg-2 song p-4 bg-gray-100 mb-2">
              <div class="wrapper flex items-center">
                <div class="mr-6">
                <img :src="song.cover_art_url" alt="" class="img-fluid rounded" /></div>
                 <div>
      ...
      <div class="music-player">
        ...
        <div class="container">
          <transition name="height">
            ...
            >
              <div class="wrap">
                <div class="song-wrap" v-for="song in playlist.songs" :key="song.id" @click="play(song)" >
...
defaultSong:
    ...
    songs: [
    ...
    
      {
        ...
        cover_art_url:
          "https://www.1mg.com/articles/wp-content/uploads/2016/01/happy-image-2.jpg"
      },
        {
        id: 4,
      ...
      },
       {
        ...
        cover_art_url:
          "https://st.depositphotos.com/1001890/2235/i/600/depositphotos_22353557-stock-photo-smiling-cute-baby.jpg"
      },
      {
        id: 6,
        title: "Hamble",
        ...
        cover_art_url:
          "https://scx2.b-cdn.net/gfx/news/2017/whoshappywho.jpg"
      },
